...
function begreen_scripts() {
	...
	// Theme scripts
	wp_enqueue_script( 'begreen-jquery', js_uri() . 'jquery-3.1.1.min.js' , '3.1.1', true );
    //Bootstrap Core JavaScript
	wp_enqueue_script( 'begreen-bootstrap', js_uri() . 'bootstrap.min.js', array('begreen-jquery'), true );
    //Plugin JavaScript
	wp_enqueue_script( 'begreen-js-plugin', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js', '1.3' , array('begreen-jquery'), true );
	wp_enqueue_script( 'begreen-jqBootstrapValidation', js_uri() . 'jqBootstrapValidation.js'  , true );
    //Contact Form JavaScript
	wp_enqueue_script( 'begreen-contact_me', js_uri() . 'contact_me.js'  );
    
    //Theme JavaScript
	wp_enqueue_script( 'begreen-freelancer.min', js_uri() . 'freelancer.min.js' );
